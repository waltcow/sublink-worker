  ...
  switch (type) {
    ...
    case "vmess": {
      ...
      return {
        ...
        tcp_fast_open:
          typeof p["fast-open"] !== "undefined" ? !!p["fast-open"] : false,
        transport,
        tls,
    ...
    case "hy2": {
      ...
      return {
        ...
        alpn: toArray(p.alpn),
        fast_open:
          typeof p["fast-open"] !== "undefined" ? !!p["fast-open"] : undefined,
      };
    }
    case "tuic": {
      return {
        ...
        zero_rtt:
          typeof p["zero-rtt"] !== "undefined" ? !!p["zero-rtt"] : undefined,
        reduce_rtt:
          typeof p["reduce-rtt"] !== "undefined"
            ? !!p["reduce-rtt"]
            : undefined,
        fast_open:
          typeof p["fast-open"] !== "undefined" ? !!p["fast-open"] : undefined,
        disable_sni:
          typeof p["disable-sni"] !== "undefined"
            ? !!p["disable-sni"]
            : undefined,
      };
    }
