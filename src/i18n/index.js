...
export const translations = {
  "zh-CN": {
    ...
    ruleProviderFormat: "Clash 规则格式",
    ruleProviderFormatYaml: "YAML（兼容性更好）",
    ruleProviderFormatText: "Text（list）",
    ruleProviderFormatMrs: "MRS（性能更好）",
    missingInput: "缺少输入参数",
  ...
  "en-US": {
    ...
    ruleProviderFormat: "Clash Rule Format",
    ruleProviderFormatYaml: "YAML (Better compatibility)",
    ruleProviderFormatText: "Text (list)",
    ruleProviderFormatMrs: "MRS (Better performance)",
    ...
    pageKeywords: "subscription link,converter,Clash",
    ...
    urlPlaceholder:
      "Paste share links, Clash config...",
    ...
    customRuleProtocolPlaceholder:
      "Protocols (comma separated, e.g., http,ssh,dns)",
    removeCustomRule: "Remove",
    addCustomRuleJSON: "Add JSON Rule",
    customRuleJSON: "JSON Rule",
    customRuleJSONTooltip:
      "Add custom rules using JSON format, supports batch adding",
    customRulesSection: "Custom Rules",
    customRulesSectionTooltip:
      "Create custom routing rules to control traffic routing behavior. Supports both form and JSON editing modes with bidirectional conversion.",
    ...
    customShortCodePlaceholder:
      "Leave empty for auto-generation, or enter custom code",
    ...
    importConfigConfirm:
      "Importing configuration will overwrite your current settings. Continue?",
